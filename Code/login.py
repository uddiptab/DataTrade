...
def login():
	...
	secret_key="GWLZDFXCGJ"
	session=accessToken.SessionModel(client_id=client_id, secret_key=secret_key,redirect_uri="https://fyers.in/web",grant_type="authorization_code",response_type="code")
